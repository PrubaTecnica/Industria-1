...
import WhatWeDoSection from 'src/components/Maquinaria/WhatWeDoSection.vue'
import SectionParaQuien from 'src/components/Maquinaria/SectionParaQuien.vue'
import SectionProceso from 'src/components/Maquinaria/SectionProceso.vue'
import SectionContacto from 'src/components/Maquinaria/SectionContacto.vue'
